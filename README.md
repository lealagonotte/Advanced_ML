...
This project implements and compares different multi arm bandits algorithms for movie recommendation. For more information about multi-arm bandit, consult the article _Introduction to Multi-Armed Bandits_.[^3]

The algorithms compared are :
- $\epsilon$-greedy
-  Multi-armed nearest-neighbor bandit [^4]
- Dynamic clustering based contextual combinatorial multi-armed bandit (DC3MAB) [^2]

## Data

We use a combination of synthetic data and real data. 

The real data commes from the MovieLens 1M data [^1], widely adopted benchmark in recommen-
dation system research, provided by the GroupLens Research Lab. The dataset contains anonymized
...
[1] Harper, F. Maxwell and Joseph A. Konstan (Dec. 2015). “The MovieLens Datasets: History and
...
[2] Sanz-Cruzado, Javier, Pablo Castells, and Esther López (2019). “A simple multi-armed nearest-
...
[3] Slivkins, Aleksandrs (2019). “Introduction to Multi-Armed Bandits”. In: Foundations and Trends in
Machine Learning 12.1–2, pp. 1–286.
[4] Yan, Cairong et al. (2022). “Dynamic clustering based contextual combinatorial multi-armed ban-
